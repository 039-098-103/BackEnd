...
const { accRegister, getCart, addToCart, removeFromCart, getInfo, editInfo, getOrderList, addOrder, editAddress, updateCart,getCartById } = require('../controllers/customerController')
